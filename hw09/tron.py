...
"""
#Worked with Alec late into the night.
...
while not done:
    ...
    for event in pygame.event.get():#more quitting rules.
       ...
       # Player 2
       elif event.type == KEYDOWN and event.key == K_UP and direct2 != south:
           direct2 = north    
       elif event.type == KEYDOWN and event.key == K_LEFT and direct2 != east:
           direct2 = west
       elif event.type == KEYDOWN and event.key == K_DOWN and direct2 != north:
           direct2 = south
       elif event.type == KEYDOWN and event.key == K_RIGHT and direct2 != west:
           direct2 = east   
